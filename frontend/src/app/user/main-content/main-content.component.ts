...
export class MainContentComponent implements OnInit {
  ...
  constructor(
    ...
    const categoryId1 = '67df070d479ce13ff3b92456';
    const categoryId2 = '67df0735479ce13ff3b92457';

    // Making two requests
    forkJoin([
      this.productService.getProductbyCategory(categoryId1),
      this.productService.getProductbyCategory(categoryId2)
    ]).subscribe((responses: any[]) => {
      // Combining both responses into a single array
      this.resp = [...responses[0], ...responses[1]];
      this.exclusiveList = this.resp;
    });
